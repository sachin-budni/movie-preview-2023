...
const routes: Routes = [
      ...
      { path: 'popular/:id', loadComponent: () => import('../../shared/components/details/details.component').then(c => c.DetailsComponent), data: { type: 'movie' } },
      { path: 'upcoming/:id', loadComponent: () => import('../../shared/components/details/details.component').then(c => c.DetailsComponent), data: { type: 'movie' } },
      { path: 'top-rated/:id', loadComponent: () => import('../../shared/components/details/details.component').then(c => c.DetailsComponent), data: { type: 'movie' } },
      { path: 'now-playing/:id', loadComponent: () => import('../../shared/components/details/details.component').then(c => c.DetailsComponent), data: { type: 'movie' } },
